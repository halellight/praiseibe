...
export const COMPENDIUM_DATA: CompendiumItem[] = [
    ...
    },
    {
        ...
        category: "Civic Tech",
        title: "RateDem",
        subtitle: "Leader Rating Platform",
        description: "Empowering Nigerian citizens through transparent data and collective feedback. Shaping the national narrative, one rating at a time.",
        link: "https://ratedem.vercel.app/",
        tags: ["Next.js", "Civic Engagement", "Data Feedback"],
    },
    {
        id: "lockedingenz-2026",
        type: "project",
        year: "2026",
        category: "Civic Tech",
        title: "LockedIn GenZ",
        subtitle: "Voter Mobilization Platform",
        description: "A comprehensive platform powered by Yiaga Africa designed to mobilize Abuja residents for Area Council Elections by providing polling unit locators and candidate information.",
        link: "https://lockedingenz.vercel.app/",
        tags: ["Next.js", "Tailwind CSS", "Civic Tech", "Election Information"],
    },
    {
        id: "naijademocracy-2026",
        type: "project",
        year: "2026",
        category: "Civic Tech",
        title: "Naija Democracy",
        subtitle: "Political History Archive",
        description: "An educational platform that provides an interactive archive of Nigeria's political history, featuring timelines, maps, and detailed records since 1960.",
        link: "https://naijademocracy.vercel.app/",
        tags: ["Next.js", "Framer Motion", "Civic Tech", "Educational", "History"],
    },
    {
        id: "goshenkitchen-2026",
        type: "project",
        year: "2026",
        category: "Hospitality",
        title: "Goshen Kitchen",
        subtitle: "Premium Catering Service",
        description: "A premium catering service specializing in authentic Nigerian cuisine, dedicated to bringing traditional flavors to various events and celebrations.",
        link: "https://www.goshenkitchen.com.ng/",
        tags: ["React", "Tailwind CSS", "Catering", "Hospitality"],
    },
    {
        id: "inec-po-2026",
        type: "volunteer",
        ...
        subtitle: "INEC | FCT Area Council Elections",
        description: "Managed a polling unit in Damangaza Settlement with over 1,071 registered voters. Orchestrated voter accreditation via BVAS and ensured real-time result transparency through Nigeria's IReV portal.",
        meta: ["Damangaza Settlement", "1,071 Voters"],
        tags: ["Election Management", "Public Service", "Civic Engagement"],
    },
    {
        id: "ngtrak",
        type: "project",
        ...
        description: "This platform enhances fiscal transparency by transforming complex Nigerian state budget data into intuitive visualizations.",
